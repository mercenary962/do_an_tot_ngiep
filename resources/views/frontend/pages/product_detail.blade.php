										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Nhận xét</a>
                                                </div>
                                                @php 
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Bạn phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> Hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a>
