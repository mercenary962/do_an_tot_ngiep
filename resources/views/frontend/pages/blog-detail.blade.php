                    ...
                    <div class="blog-single-main">
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Đăng tải bình luận</span><span class="comment_btn reply" style="display: none;">Trả lời bình luận</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Bạn phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> HOẶC <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a> for comment.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Hạng mục bài viết</h3>
