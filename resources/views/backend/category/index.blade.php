...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm Danh mục sản phẩm"><i class="fas fa-plus"></i> Thêm Danh mục sản phẩm</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Không tìm thấy Danh mục sản phẩm nào!!! Vui lòng thêm Danh mục sản phẩm</h6>
        @endif
      </div>
    </div>
</div>
