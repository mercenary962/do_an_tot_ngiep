...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Thêm Danh sách vận chuyể"><i class="fas fa-plus"></i> Thêm danh sách vận chuyển</a>
    </div>
    <div class="card-body">
