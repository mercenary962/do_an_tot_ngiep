...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        if($already_cart) {
            ...
            if ($already_cart->product->stock < $already_cart->quantity || $already_cart->product->stock <= 0) return back()->with('error','Không đủ số lượng trong kho.');
            $already_cart->save();
            ...
            if ($cart->product->stock < $cart->quantity || $cart->product->stock <= 0) return back()->with('error','Không đủ số lượng trong kho');
            $cart->save();
    ...
    public function singleAddToCart(Request $request){
        ...
        if($product->stock <$request->quant[1]){
            return back()->with('error','Đã hết hàng. Hãy chọn mua sản phẩm khác');
        }
