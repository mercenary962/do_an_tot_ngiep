...
class PostCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Đã thêm Hạng mục bài viết');
        }
        else{
            request()->session()->flash('error','Vui lòng thử lạin!!');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Cập nhật Hạng mục bài viết thành công');
        }
        else{
    ...
    public function destroy($id)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Lỗi, không thể xóa ');
        }
        return redirect()->route('post-category.index');
    }
}
